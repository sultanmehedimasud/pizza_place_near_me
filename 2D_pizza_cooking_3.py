...
def draw_toppings_bar():
    ...
    draw_rect(-550, 200, 700, 100, (0.85, 0.8, 0.75))
    
    # Draw individual toppings
    for topping, position in topping_positions.items():
        if topping == "sauce":
            draw_circle(position[0], position[1], 25, (1, 0, 0))
            draw_text(position[0] - 20, position[1] - 40, "Sauce")
        elif topping == "cheese":
            draw_circle(position[0], position[1], 25, (1, 1, 0))
            draw_text(position[0] - 25, position[1] - 40, "Cheese")
        elif topping == "sausage":
            draw_circle(position[0], position[1], 25, (0.6, 0.3, 0))
            draw_text(position[0] - 25, position[1] - 40, "Sausage")
        elif topping == "pepperoni":
            draw_circle(position[0], position[1], 25, (0.8, 0.1, 0.1))
            draw_text(position[0] - 30, position[1] - 40, "Pepperoni")
        elif topping == "onion":
            draw_circle(position[0], position[1], 25, (1, 1, 1))
            draw_text(position[0] - 20, position[1] - 40, "Onion")
        elif topping == "black_olive":
            draw_circle(position[0], position[1], 25, (0, 0, 0))
            draw_text(position[0] - 20, position[1] - 40, "Olives")
        elif topping == "oregano":
            draw_circle(position[0], position[1], 25, (0, 0.5, 0))
            draw_text(position[0] - 25, position[1] - 40, "Oregano")
...
def draw_pizza():
    ...
    if bread_after_oven and not pizza_in_box:
        # Draw cooked base
        draw_circle(pizza_position[0], pizza_position[1], 50, (0.8, 0.6, 0.3))
        ...
        for topping in pizza_toppings:
            if topping == "sauce":
                ...
                for i in range(8):
                    ...
                    x = pizza_position[0] + math.cos(angle) * 30
                    y = pizza_position[1] + math.sin(angle) * 30
                    draw_circle(x, y, 7, (0.7, 0.1, 0.05))
            elif topping == "onion":
                for i in range(10):
                    angle = i * 36 * math.pi / 180
                    x = pizza_position[0] + math.cos(angle) * 35
                ...
                for i in range(100):
                    ...
                    distance = 20 + 25 * (i % 5) / 5.0
                    x = pizza_position[0] + math.cos(angle) * distance
                    y = pizza_position[0] + math.sin(angle) * distance
                    glVertex2f(x, y)
                glEnd()
...
def draw_pizza_box():
    if pizza_box_open:
        # Open box
        draw_rect(box_position[0] - 70, box_position[1] - 60, 140, 10, (0.8, 0.6, 0.4))
        draw_rect(box_position[0] - 70, box_position[1] - 60, 10, 90, (0.8, 0.6, 0.4))
        draw_rect(box_position[0] + 60, box_position[1] - 60, 10, 90, (0.8, 0.6, 0.4))
        draw_rect(box_position[0] - 70, box_position[1] + 30, 140, 10, (0.8, 0.6, 0.4))
        
        # Box lid (open)
        draw_rect(box_position[0] - 70, box_position[1] + 40, 140, 5, (0.7, 0.5, 0.3))
        draw_rect(box_position[0] - 70, box_position[1] + 40, 5, 70, (0.7, 0.5, 0.3))
        draw_rect(box_position[0] + 65, box_position[1] + 40, 5, 70, (0.7, 0.5, 0.3))
        draw_rect(box_position[0] - 70, box_position[1] + 110, 140, 5, (0.7, 0.5, 0.3))
        
        draw_text(box_position[0] - 25, box_position[1] + 90, "OPEN BOX")
    
    elif pizza_box_closed:
        # Closed box
        draw_rect(box_position[0] - 70, box_position[1] - 60, 140, 70, (0.7, 0.5, 0.3))
        draw_text(box_position[0] - 30, box_position[1], "CLOSED BOX")

def draw_instructions():
    y_pos = 270
    for line in instructions:
        draw_text(-590, y_pos, line)
        y_pos -= 20
...
#Problem- colouring issue, and open box invisible